...
[`@aws-sdk/client-pinpoint-sms-voice-v2`](https://www.npmjs.com/package/@aws-sdk/client-pinpoint-sms-voice-v2/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X1v39v2x9zHsOYpXHjvLA7wfi2U9n3WrrakMHshWqYuiKMuazHY5ObvGJmomNuiP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pinpoint-sms-voice-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.712.0/index.min.mjs": "sha384-X1v39v2x9zHsOYpXHjvLA7wfi2U9n3WrrakMHshWqYuiKMuazHY5ObvGJmomNuiP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pinpoint-sms-voice-v2/blob/refs/tags/3.712.0/LICENSE
```
