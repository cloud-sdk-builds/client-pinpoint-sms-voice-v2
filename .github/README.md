...
[`@aws-sdk/client-pinpoint-sms-voice-v2`](https://www.npmjs.com/package/@aws-sdk/client-pinpoint-sms-voice-v2/v/3.1052.0).
...
- @aws-sdk/client-pinpoint-sms-voice-v2 v3.1052.0 - [https://cloud-sdk-builds.github.io/?sdk=client-pinpoint-sms-voice-v2&version=3.1052.0](https://cloud-sdk-builds.github.io/?sdk=client-pinpoint-sms-voice-v2&version=3.1052.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.1052.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8TDkN8rdjPBBiueEVuAfu9xVnxwlhxsVNPlNvpVHYv+QHMgLiYCeOsQwPeGV+i+w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pinpoint-sms-voice-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.1052.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.1052.0/index.min.mjs": "sha384-8TDkN8rdjPBBiueEVuAfu9xVnxwlhxsVNPlNvpVHYv+QHMgLiYCeOsQwPeGV+i+w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pinpoint-sms-voice-v2/blob/refs/tags/3.1052.0/LICENSE
```
