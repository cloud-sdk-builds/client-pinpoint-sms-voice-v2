...
[`@aws-sdk/client-pinpoint-sms-voice-v2`](https://www.npmjs.com/package/@aws-sdk/client-pinpoint-sms-voice-v2/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-btuJbquOloJ6p8whfm/10budCqgLxzEdar6B6OC1gpl5m3L0XMPt724lyTeSJuiY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pinpoint-sms-voice-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pinpoint-sms-voice-v2@3.370.0/index.min.mjs": "sha384-btuJbquOloJ6p8whfm/10budCqgLxzEdar6B6OC1gpl5m3L0XMPt724lyTeSJuiY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pinpoint-sms-voice-v2/blob/refs/tags/3.370.0/LICENSE
```
